...
export PORT=20034 # same as the carla server port
...
export TEAM_CONFIG=model_ckpt/PPTF_clear_long_0109
export SCENARIOS=leaderboard/data/scenarios/town05_all_scenarios.json

##################################################
export SAVE_PATH=data/PPTF_clear_long_0109_1 # path for saving episodes while evaluating
export CHECKPOINT_ENDPOINT=results/PPTF_clear_long_0109_1.json
...
##################################################
export SAVE_PATH=data/PPTF_clear_long_0109_2 # path for saving episodes while evaluating
export CHECKPOINT_ENDPOINT=results/PPTF_clear_long_0109_2.json
